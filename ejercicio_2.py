...
print("El valor almacenado en numero_1 es:")
print(numero_1)
print("El valor almacenado en numero_2 es:", numero_2)
...
print("El resultado de sumar", numero_1, "y", numero_2, "es:")

# Resta
resta= numero_1 - numero_2
print("El resultado de restar", numero_1, "y", numero_2, "es:")

# División
division= numero_1 / numero_2
print("El resultado de dividir", numero_1, "y", numero_2, "es:")
